...
TumblerThumbnailFlavor *tumbler_thumbnail_flavor_new_with_minimum_size
                                                              (const gchar            *name,
                                                               gint                    width,
                                                               gint                    height,
                                                               gint                    min_width,
                                                               gint                    min_height) G_GNUC_MALLOC G_GNUC_WARN_UNUSED_RESULT;
...
void                    tumbler_thumbnail_flavor_get_size     (TumblerThumbnailFlavor *flavor,
                                                               gint                   *width,
                                                               gint                   *height);
void                    tumbler_thumbnail_flavor_get_min_size (TumblerThumbnailFlavor *flavor,
                                                               gint                   *width,
                                                               gint                   *height);
void                    tumbler_thumbnail_flavor_calculate_size 
